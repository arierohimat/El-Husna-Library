            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Kelas: <span className="font-semibold text-emerald-600">{data?.kelas || user.kelas}</span>
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <p className="text-2xl font-bold text-gray-900">
                            {data?.students.reduce(
                                (sum, s) => sum + s.stats.totalBorrowed,
                                0,
                            ) || 0}
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <div className="p-3 bg-amber-50 rounded-xl w-fit mb-3">
                            <BookMarked className="w-6 h-6 text-amber-600" />
                        </div>
                        <p className="text-sm text-gray-600">Buku Selesai Dibaca</p>
                        <p className="text-2xl font-bold text-gray-900">
                            {data?.students.reduce(
                                (sum, s) => sum + s.stats.booksReturned,
                                0,
                            ) || 0}
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <div className="p-3 bg-red-50 rounded-xl w-fit mb-3">
                            <AlertCircle className="w-6 h-6 text-red-600" />
                        </div>
                        <p className="text-sm text-gray-600">Terlambat</p>
                        <p className="text-2xl font-bold text-gray-900">
                            {data?.students.reduce(
                                (sum, s) => sum + s.stats.booksOverdue,
                                0,
                            ) || 0}
                        </p>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-100">
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">
                            {loading
                                ? "Memuat..."
                                : `${data?.totalStudents || 0} siswa di kelas ${data?.kelas || ""}`}
                        </p>
                    </div>
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-6 text-center">
                                                ...
                                                {student.stats.totalFine > 0 && (
                                                    <div>
                                                        <p className="text-xs text-gray-500">Denda</p>
                                                        <p className="text-sm font-bold text-orange-600">
                                                            {formatCurrency(student.stats.totalFine)}
                                                        </p>
                                                    </div>
                                                )}
                                                <div className="ml-2">
                                                                    ...
                                                                    <div className="flex justify-between items-start">
                                                                        <div>
                                                                            ...
                                                                            <p className="text-xs text-gray-400 mt-1">
                                                                                Pinjam: {formatDate(b.borrowDate)} •
                                                                                Tempo: {formatDate(b.dueDate)}
                                                                                {b.returnDate &&
                                                                        ...
                                                                        <div className="flex flex-col items-end gap-1">
                                                                            <span
                                                                                className={`px-2 py-0.5 rounded-full text-xs font-semibold ${b.status === "RETURNED"
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="flex justify-between text-xs text-gray-400">
                                                                            <span>
                                                                                Halaman {rp.currentPage} / {rp.totalPages}
                                                                            </span>
                                                                            <span>
                                                                                Update: {formatDate(rp.updatedAt)}
                                                                            </span>
                                                                        </div>

                                                                        {rp.notes && (
                                                                            <p className="text-xs text-gray-600 mt-2 bg-gray-50 rounded-lg px-2 py-1.5 italic">
                                                                                "{rp.notes}"
                                                                            </p>
                                                                        )}
                                                                    </div>
