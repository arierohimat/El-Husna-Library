...
export default function MembersPage() {
  ...
  useEffect(() => {
    if (user?.role === "ADMIN") fetchSiswaList();
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-100">
                  {siswaList.map((s) => (
                    <tr key={s.id} className="h-16 hover:bg-gray-50 transition">
                      ...
                      <td className="px-6 py-3 text-sm text-gray-600">{s.username}</td>
      ...
      >
        <DialogContent className="rounded-2xl max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Isi informasi lengkap siswa</DialogDescription>
          </DialogHeader>
      ...
      <AlertDialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        <AlertDialogContent className="rounded-2xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Anda yakin ingin menghapus "{selectedSiswa?.name}"?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
