...
export default function UsersPage() {
  ...
  const emptyForm = {
    ...
    phone: "",
    address: "",
    role: "SISWA" as "ADMIN" | "SISWA" | "GURU",
  };
  ...
  const validateForm = (isEdit: boolean) => {
    ...
    if (formData.role === "GURU" && !formData.kelas) {
      return "Kelas harus dipilih untuk Guru";
    }
    return null;
  };
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...formData,
      kelas: formData.role === "GURU" ? formData.kelas || null : null,
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      role: e.target.value as "ADMIN" | "SISWA" | "GURU",
                    })
                  }
                >
