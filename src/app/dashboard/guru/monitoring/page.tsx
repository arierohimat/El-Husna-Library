                                            ...
                                            <div className="flex items-center gap-4 sm:gap-6 text-center">
                                                ...
                                                <div className="hidden sm:block">
                                                    ...
                                                    <p className="text-sm font-bold text-teal-600">
                                                        {student.stats.totalEbooksRead || 0}
                                                    </p>
                                                </div>
                                                <div>
                                            ...
                                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
                                                ...
                                                <div>
                                                    <h4 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                                                        ...
                                                        Aktivitas E-Book Digital
                                                    </h4>
                                                    {!student.ebookAccesses || student.ebookAccesses.length === 0 ? (
                                                        <p className="text-xs text-gray-400 italic bg-white p-4 rounded-xl border border-gray-100">
                                                            Belum ada E-Book yang dibaca
                                                        </p>
                                                    ) : (
                                                        <div className="space-y-2">
                                                            {student.ebookAccesses.map((ea) => (
                                                                <div
                                                                    key={ea.id}
                                                                    className="bg-white rounded-xl p-3 border border-gray-200 shadow-sm"
                                                                >
                                                                    <div className="flex justify-between items-start">
                                                                        ...
                                                                        <span className="text-[10px] font-bold text-teal-700 bg-teal-50 px-2 py-0.5 rounded-full">
                                                                            {ea.accessCount}x dibaca
                                                                        </span>
                                                                    </div>
                                                                    <p className="text-[10px] text-gray-400 mt-2">
                                                                        Terakhir: {formatDate(ea.lastReadAt)}
                                                                    </p>
                                                                </div>
                                                            ))}
                                                        </div>
